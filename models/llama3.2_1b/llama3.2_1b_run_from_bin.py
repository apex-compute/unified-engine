...
Design mirrors test.py (see notes_llama3.2_1b.md): full-4 GB DRAM layout, dynamic-PBI single
...
Usage:
  ...
  python llama3.2_1b_run_from_bin.py --no-fpga-penalty --dev xdma0     # plain greedy (no penalty)
"""
...
class Llama32_1b_RunFromBin(UnifiedEngine):
    ...
    def tensor_init(self) -> None:
        ...
        # llama3.2_1b_test.py — so its baked address matches the fpga-penalty bin. all-zero = no penalty.
    ...
    def _write_penalty_bias(self, prev_tokens) -> None:
        ...
        llama3.2_1b_test.py._write_penalty_bias (the bin compiled there bakes this contract)."""
        ...
        if bool(getattr(self, "fpga_penalty", False)):
            ...
            if not os.path.exists(meta_path):
                raise FileNotFoundError(
                    ...
                    f"  build it with:  python llama3.2_1b_test.py --fpga-penalty")
