...
- **Cores (--multi-core):** 10
- **Peak throughput:** 384.0 GFLOPS (300.0 MHz × 128 × 10 core(s))
- **DRAM read speed:** 31793.0 MB/s (10-core aggregate, private regions)
...
- **Total programs.bin size:** 35.9 MB
- **Vision section:** 1.8 MB
- **Prefill program:** 6411.4 KB
...
- **Vision FPGA run time (HW latency):** 5767.3 ms (5767257.4 us)
- **Vision reported FLOPS:** 199.2 GFLOPS
- **Vision utilization (% peak):** 51.9%
- **Vision end-to-end (CPU timer):** 5.9 s

## Prefill

- **Prefill seq_len:** 272
- **Prefill FPGA run time (HW latency):** 5195.8 ms (5195794.0 us)
- **Prefill reported FLOPS:** 203.7 GFLOPS
- **Prefill utilization (% peak):** 53.1%
- **Prefill end-to-end (CPU timer):** 5.3 s
