#!/usr/bin/env python3
"""Compile a YOLOv5 variant into one-kick whole-graph artifacts."""
...
def build_artifact(*, variant: str = "s", checkpoint: Path | None = None,
    ...
    print(f"  default_model_image={report['model_bytes'] / 2**20:.2f} MiB "
          f"whole_graph_program={report['program_bytes']} bytes")
    print("  profiles=" + ", ".join(
