...
YOLOv5 requires a convolution-enabled FPGA image with native
convolution/max-pool modes and registers.
...
inference does not write those live CSRs. Select and program a compatible FPGA
image separately from the model artifact.
