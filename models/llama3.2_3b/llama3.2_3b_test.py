...
def main():
    ...
    # break long-context loops. The penalty runs entirely on the FPGA; no host penalty or sampling.
    ...
    # argmax returns the penalized token (no logit readback). Separate _fpgapenalty bin. Validated
    # params for 3B (logit_max~26.9, gap~4.25): alpha=1.0. See notes_repetition_penalty_fpga_bias.md.
