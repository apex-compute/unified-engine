...
``qwen3_4b_test.py`` once on a build machine with HF access to
...
_spec = _ilu.spec_from_file_location(
    "_qwen3_4b_test_for_runbin",
    os.path.join(SCRIPT_DIR, "qwen3_4b_test.py"),
)
_test_mod = _ilu.module_from_spec(_spec)
_spec.loader.exec_module(_test_mod)
Qwen3_4b_UnifiedEngine = _test_mod.Qwen3_4b_UnifiedEngine
