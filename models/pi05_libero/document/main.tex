...
$1.6$\,GHz with $100$\,GB/s DRAM, in a base 8-engine and a doubled 16-engine
option ($64$~MACs per engine; $1638.4$ / $3276.8$\,GFLOP/s aggregate peak).
Batch~1, 10 denoise steps. Linear $61.5\times$ / $123\times$ compute scaling
of the measured FPGA run at its achieved \%-of-peak; neither option is
bandwidth-bound (see below).}
\label{tab:timing-silicon}
\begin{tabular}{@{}lcccc@{}}
\toprule
& \multicolumn{2}{c}{\textbf{8 engines}} & \multicolumn{2}{c}{\textbf{16 engines}} \\
...
\vspace{2pt}
\noindent\textbf{Why the projection is linear.} Going from one engine at
...
demand $<$10\,GB/s of the $100$ available), and doubling to 16 engines only
lifts the ridge to $\approx$33\,FLOP/byte --- still $\geq$6$\times$ clear. So
neither option is bandwidth-bound, and times extrapolate linearly at the
FPGA's measured $88$--$93\%$ of peak, assuming ideal engine scaling:
$3.15$\,s per inference ($0.32$\,inf/s) with 8 engines and $1.57$\,s
($0.64$\,inf/s) with 16 --- $61.5\times$ / $123\times$ the FPGA, within
...
\vspace{2pt}
\noindent\textbf{Power.} The RTX~5070 is a $250$\,W-TGP board (6144 CUDA
cores, boost $\sim$2.5\,GHz, $12$\,GB GDDR7 at $672$\,GB/s); at $130.2$\,ms
per inference that is $\approx$33\,J per action chunk at TGP. The \ue{} FPGA
instance draws $\sim$5\,W --- $\sim$970\,J per (much slower) inference.
Holding the same $\sim$5\,W-class envelope in silicon, the projections land
at $\approx$16\,J (8 engines) and $\approx$8\,J (16 engines) per action
chunk: $2.1\times$ and $4.1\times$ less energy per inference than the GPU
($0.064$ and $0.127$ vs.\ $0.031$\,inf/s/W).

\vspace{2pt}
\noindent\textbf{Config.} FPGA: \ue{} v1 IP on Xilinx Kintex-7 at $208$\,MHz
($26.6$\,GFLOP/s theoretical peak, $\sim$5\,W), \iffour{}
...
$\sim$13\,GB model in a sub-4\,GB budget. Tables~\ref{tab:budget}--\ref{tab:timing-silicon} complete
