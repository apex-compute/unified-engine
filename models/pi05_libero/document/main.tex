...
\AddToHook{shipout/background}{%
  \put(0.5\paperwidth,-0.5\paperheight){%
    \makebox(0,0){\rotatebox{45}{%
      \begin{tabular}{@{}c@{}}
        \textcolor{gray!25}{\fontsize{68}{68}\selectfont\bfseries CONFIDENTIAL}\\[10pt]
        \textcolor{gray!25}{\fontsize{22}{26}\selectfont\bfseries Prepared for The Bot Company}
      \end{tabular}}}}%
}
...
\author{Apex Compute\\[1pt]\texttt{hunlu@apexcompute.com}}
\date{\vspace{-1em}}
...
\textbf{\iffour{} weights / DRAM budget.} The $\sim$13\,GB full-precision
checkpoint
...
the prefill, compressing $832{\to}576$ (bit-identical, $\sim$31\% less
prefill work). Rotary positions use
...
with depth, V worse than K ($10.7$ vs.\ $16.0$\,dB mean); and while each
denoise step's velocity holds up on its own ($23.5$\,dB), the Euler loop
compounds that per-step error through Eq.~\eqref{eq:euler}---$x_t$
...
Peak GFLOP/s (\bfteen{}) & 61\,740 & 26.6 & 1\,638 & 3\,277 \\
