...
(Tables~\ref{tab:timing-gpu}--\ref{tab:timing-silicon}). GPU peaks are the
FP32 shader rate and the dense-tensor \bfteen{} rate; the \ue{} computes in
\bfteen{} natively.}
\label{tab:platforms}
\setlength{\tabcolsep}{4pt}
\begin{tabular}{@{}lcccc@{}}
...
Peak GFLOP/s (fp32) & 30\,900 & --- & --- & --- \\
Peak GFLOP/s (\bfteen{}) & 61\,800 & 26.6 & 1\,638 & 3\,277 \\
