...
$1.6$\,GHz with $100$\,GB/s DRAM, in two chip variations ---
\textbf{Chip Variation~1} (8~engines, $\sim$5\,W) and \textbf{Chip
Variation~2} (16~engines, wattage TBD) --- $64$~MACs per engine, $1638.4$ /
...
per inference that is $\approx$33\,J per action chunk at TGP. Chip
Variation~1 is specified at $\sim$5\,W: $\approx$16\,J per action chunk ---
$2.1\times$ less energy per inference than the GPU ($0.064$ vs.\
$0.031$\,inf/s/W) at $1/50$th the board power. Chip Variation~2's wattage is
still TBD; at $1.57$\,s per inference it undercuts the GPU's energy per
chunk at any draw below $\approx$21\,W, and matches Variation~1's
$\approx$16\,J at $10$\,W. Table~\ref{tab:platforms} collects the
comparison.
...
(Tables~\ref{tab:timing-gpu}--\ref{tab:timing-silicon}); GPU energy is at
TGP.}
\label{tab:platforms}
\setlength{\tabcolsep}{4pt}
\begin{tabular}{@{}lcccc@{}}
...
\midrule
Compute            & 6144 CUDA cores & 1 engine (64 MACs) & 8 engines & 16 engines \\
...
Energy / chunk     & $\approx$33\,J & --- & $\approx$16\,J & TBD \\
Efficiency         & 0.031\,inf/s/W & --- & 0.064\,inf/s/W & TBD \\
\bottomrule
\end{tabular}
\end{table}
