...
LIBERO comparison---the FPGA \iffour{} policy vs.\ the CUDA \bfteen{} reference
over 10 episodes, by task success and action-chunk agreement.

\begin{table}[H]
\centering\small
\caption{LIBERO closed-loop agreement: FPGA (\iffour{}) vs.\ CUDA (\bfteen{}),
10 episodes. \emph{Reserved --- fill from the paired eval run.}}
\label{tab:libero}
\begin{tabular}{@{}lc@{}}
\toprule
\textbf{Metric} & \textbf{Value} \\
\midrule
FPGA \iffour{} success rate      & \numTBD/10 \\
CUDA \bfteen{} success rate      & \numTBD/10 \\
Action-chunk agreement (dB)      & \numTBD \\
\bottomrule
\end{tabular}
\end{table}
