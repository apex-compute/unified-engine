...
The [noisy-audio report](validation/20260914_noisy20s/README.md) adds eight
tests over 20 seconds, both FPGA outputs, and
[KU5P resource utilization](validation/20260914_noisy20s/README.md#fpga-resources).
