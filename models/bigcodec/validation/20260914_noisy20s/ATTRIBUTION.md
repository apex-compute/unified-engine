...
The input WAVs here are byte-identical to those DPDFNet test sequences. CPU and FPGA WAVs are BigCodec encoder/quantizer/decoder reconstructions of the noisy inputs. No additional normalization, noise mixing, truncation or crossfade was applied. Reconstructed audio remains attributed to the source recordings and their licenses.
