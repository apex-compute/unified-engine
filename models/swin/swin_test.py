...
def main():
    ...
    _original_print(f"DMA/DRAM: H2C={DMA_DEVICE_H2C}, C2H={DMA_DEVICE_C2H}, USER={user_dma_core.DMA_DEVICE_USER}, params=0x{SWIN_PARAMS_BASE:08X}, tensor=0x{SWIN_TENSOR_BASE:08X}, program=0x{SWIN_PROGRAM_BASE:08X}, end=0x{user_dma_core.DRAM_END_ADDR:08X}")
