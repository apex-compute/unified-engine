    ...
    def weight_init(self) -> None:
        ...
        for s in range(self.NUM_STAGES):
            ...
            for l in range(self.DEPTHS[s]):
                ...
                # transformers>=5.13.dev nests q_proj/k_proj/v_proj directly on SwinAttention.
                ...
                # Output projection (attention) — transformers>=5.13.dev: SwinAttention.o_proj
                ...
                # MLP expand: (mlp_dim, dim) — transformers>=5.13.dev: SwinLayer.mlp.fc1
                ...
                # MLP contract: (dim, mlp_dim) — transformers>=5.13.dev: SwinLayer.mlp.fc2
